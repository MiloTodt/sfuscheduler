...
BUGGED_DEPARTMENTS = %w[BOT WDA DEVS FPA].freeze # SFU API returns some departments that actually don't have courses (so fetching them returns an error), this is a list of them
